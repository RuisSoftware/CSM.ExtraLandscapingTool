...
namespace CSM.ExtraLandscapingTools.Surface
{
    public class SerializableDataExtension : SerializableDataExtensionBase
    {
        ...
        public override void OnLoadData()
        {
            ...
            {
                DataSerializer.Deserialize<SurfaceManager.Data>(ms, DataSerializer.Mode.Memory, LegacyResolver);
            }
        }

        private static System.Type LegacyResolver(string typeName)
        {
            if (typeName != null && typeName.Contains("SurfaceManager+Data"))
            {
                return typeof(SurfaceManager.Data);
            }
            return null;
        }
